...
const socialsData: SocialNetworks[] = [
  ...
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https://facebook.com/profile.php?id=100040268671290&mibextid=ZbWKwL",
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "https://www.instagram.com/aqsaa_tabassum/?igsh=MXU1OHh6bGM4bDc3aw%3D%3D#",
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/aqsaarazzaq",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
              Shop.co © 2005-2024,All Right Reserve
              <Link
                href=""
          ...
          <h3 className="font-bold">By Aqsa Tabassum</h3>
        </div>
        <LayoutSpacing />
      </div>
    </footer>
